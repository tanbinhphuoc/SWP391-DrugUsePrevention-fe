...
const Dashboard = () => {
  ...
  const fetchDashboardData = async (token) => {
    try {
      // Fetch account stats
      const accountResponse = await fetch("https://localhost:7092/api/Auth/users", {
        method: "GET",
        headers: {
      ...
      // Fetch course stats
      const courseResponse = await fetch("https://localhost:7092/api/Course/GetAllCourse", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
      ...
      const appointmentResponse = await fetch("https://localhost:7092/api/Appointment/GetAll", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
      ...
      const riskResponse = await fetch("https://localhost:7092/api/RiskAssessment/GetAll", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
