...
const UserProfile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        setForm({
          userName: data.userName, // Nạp UserName từ API
          password: "", // Không nạp Password (ẩn mật khẩu)
          name: data.fullName || "",
          email: data.email || "",
          role: data.roleName || "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updateData = {
        userName: form.userName, // Gửi UserName hiện tại, không cho phép chỉnh sửa
        password: form.password || undefined, // Chỉ gửi nếu có giá trị mới
        fullName: form.name,
        phone: form.phone,
      ...
      setForm({
        userName: updatedProfile.userName, // Cập nhật UserName từ response
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl bg-white/80 backdrop-blur-sm focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all duration-300 hover:border-gray-300 hover:shadow-md placeholder:text-gray-400 cursor-not-allowed"
