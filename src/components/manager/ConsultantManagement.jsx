...
const ConsultantManagement = () => {
    ...
    const handleAddOrUpdate = async (e) => {
        ...
        try {
            ...
            if (editId === null && (!body.userName || !body.email || !body.fullName || !body.degree || !body.specialty || !body.certificateName)) {
                toast.error("Vui lòng điền đầy đủ các trường bắt buộc khi thêm mới!");
                return;
            }
            ...
            if (data.message === "Consultant updated successfully." || data.message === "Consultant created successfully.") {
                if (editId !== null) {
                    await fetchConsultants(); // Reload danh sách sau khi cập nhật
                    toast.success(data.message);
                } else {
                    const newConsultantId = data.data?.consultantID || data.consultant?.consultantID;
                    if (!newConsultantId) {
                        throw new Error("API did not return a valid consultantID");
                    }
                    const newConsultant = {
                        id: newConsultantId,
    ...
    const handleEdit = (consultant) => {
        console.log("Consultant data for edit:", consultant);
        setFormData({
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {filteredConsultants.map((consultant) => (
                        ...
                        ({consultant.totalSessions || 0} buổi)
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">Cập nhật: {consultant.updatedAt}</p>
                                    </div>
                                </div>
                                <span
                  ...
                  <span className="px-2 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">
                    {consultant.certificateName || "Chưa có"}
                  </span>
                                </div>
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <p className="text-sm text-gray-800">
                                    {consultant.dateAcquired || "Chưa có"}
                                </p>
                            </div>
                            ...
                            <div className="mb-4">
                                ...
                                <p className="text-sm text-gray-800 break-all">
                                    {consultant.googleMeetLink || "Chưa có"}
                                </p>
                            </div>
                            ...
                            <form onSubmit={handleAddOrUpdate}>
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        required={isAddMode}
                                        placeholder="Nhập tên đăng nhập (chỉ khi thêm mới)"
                                    />
                                </div>
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                                        required={isAddMode}
                                        placeholder="Nhập mật khẩu (chỉ khi thêm mới)"
                                    />
                                </div>
                                <div className="mb-4">
                                ...
                                <div className="mb-4">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            setFormData({ ...formData, hourlyRate: value === "" ? "0" : value });
                                        }}
                                        className="w-full p-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                                        required={isAddMode}
                                    />
                ...
                <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                        <div className="text-2xl font-bold text-orange-600">
                            {(consultants.reduce((sum, consultant) => sum + (consultant.rating || 0), 0) / consultants.length).toFixed(1) || "N/A"}
                        </div>
